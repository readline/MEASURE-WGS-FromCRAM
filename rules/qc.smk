...
rule cramqc__collect_quality_yield_metrics:
    ...
    shell:
        ...
        "  -R {config[references][gatkbundle][path]}/Homo_sapiens_assembly38.fasta"
        "  > {log.out} 2> {log.err}\n"
...
rule cramqc__collect_wgs_metrics:
    ...
    shell:
        ...
        "  --INTERVALS {config[references][gatkbundle][path]}/wgs_coverage_regions.hg38.interval_list"
...
rule cramqc__mosdepth:
    ...
    shell:
        ...
        "mosdepth"
        "    --threads {threads}"
        "    --fasta {config[references][gatkbundle][path]}/Homo_sapiens_assembly38.fasta"
